...
const createWindow = () => {
    mainWindow = new BrowserWindow({
        icon: path.join(__dirname, './icon/WiinBlock-Link.ico'),
       // width: 400,
        //height: 400,
        //center: true,
        //resizable: false,
    ...
    appTray = new Tray(nativeImage.createFromPath(path.join(__dirname, './icon/WiinBlock-Link.ico')));
    appTray.setToolTip('WiinBlock');
    appTray.setContextMenu(Menu.buildFromTemplate(makeTrayMenu(locale)));
